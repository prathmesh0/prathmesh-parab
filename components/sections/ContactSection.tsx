...
const CONTACT_DETAILS = [
  ...
  { icon: LinkedinIcon, label: "LinkedIn", value: "linkedin.com/in/prathmesh-parab", href: socials.find((s) => s.name === "LinkedIn")?.url },
  { icon: GithubIcon, label: "GitHub", value: "github.com/prathmeshparab", href: socials.find((s) => s.name === "GitHub")?.url },
];
